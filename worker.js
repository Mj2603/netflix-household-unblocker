// Netflix Household Unblocker - Background Script (v2.0 - Production)

const RULE_ID = 1;
const GRAPHQL_URL = "*://web.prod.cloud.netflix.com/graphql*";
const WATCH_PATH = '/watch/';
const CONTENT_SCRIPT_FILE = 'inject.js';
...
console.log("Netflix Household Unblocker background script loaded (v2.0 - Production)."); 